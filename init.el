(custom-set-variables
 ...
 '(helm-boring-buffer-regexp-list
   '("\\` " "\\`\\*helm" "\\`\\*Echo Area" "\\`\\*Minibuf" "\\`\\*helpful" "\\`\\*Flycheck" "\\`\\*EGLOT"))
 ...
 '(package-selected-packages
   '(rust-mode zig-mode format-all flycheck-eglot realgud-pdbpp ansible ansible-vault company-ansible helm-flycheck helm-xref eldoc-box realgud company-box git-gutter-fringe helpful dockerfile-mode yasnippet eslint-fix web-beautify base16-theme markdown-preview-mode nodejs-repl phi-search multiple-cursors which-key company-terraform git fish-mode magit-popup smart-mode-line pyenv-mode projectile yaml-mode virtualenvwrapper shell-pop rich-minority po-mode helm-projectile haskell-mode flycheck))
 ...
 '(safe-local-variable-values
   '((format-all-formatters
      ("Python" ruff))
     (flycheck-python-mypy-cache-dir . "/Users/david/dev/invoice_parsing/.mypy_cache")
     (flycheck-python-mypy-config . "/Users/david/dev/invoice_parsing/mypy.ini")
     (flycheck-python-mypy-cache-dir . "/Users/david/dev/telecollecte/.mypy_cache")
     (flycheck-python-mypy-config . "/Users/david/dev/telecollecte/mypy.ini")
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :extend nil :stipple nil :background "#212026" :foreground "#e6e6e8" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight regular :height 140 :width normal :foundry "nil" :family "Menlo"))))
 ...
 '(helm-selection ((t (:extend t :background "#494757" :foreground nil :weight bold))))
...
(add-to-list 'exec-path (expand-file-name "~/.nvm/versions/node/v18.18.2/bin/"))
(add-to-list 'exec-path "/opt/homebrew/bin/")
(add-to-list 'exec-path (expand-file-name "~/.pyenv/shims"))
(setenv "PATH" (concat
                "/opt/node/bin:/usr/local/bin"
                ":"
                (expand-file-name "~/.nvm/versions/node/v18.18.2/bin/")
                ":"
...
(with-eval-after-load 'eglot
  (add-to-list 'eglot-server-programs
               `((vue-web-mode :language-id "vue") . ("vue-language-server" "--stdio" :initializationOptions ,(vue-eglot-init-options))))

  (add-to-list 'eglot-server-programs
               `((js-mode :language-id "javascript") . ("vue-language-server" "--stdio" :initializationOptions ,(vue-eglot-init-options))))

  (add-to-list 'eglot-server-programs
               `((typescript-ts-mode :language-id "typescript") . ("vue-language-server" "--stdio" :initializationOptions ,(vue-eglot-init-options))))
...
;; installed npm packages in v18.18.2
;; /Users/david/.nvm/versions/node/v18.18.2/lib
